...
class InternalAffairsAndQuarterlyReportsSpider(scrapy.Spider):
    name = 'internal_affairs_and_quarterly_reports'
    allowed_domains = ['www.joplinmo.org']
    start_urls = ['http://www.joplinmo.org/1094/Internal-Affairs-Annual-and-Quarterly-Re']
